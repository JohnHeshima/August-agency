...
const formSchema = z.object({
  ...
  office: z.string({ required_error: 'Veuillez sélectionner une agence.'}),
...
export default function Contact() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    // The contact form submission relies on Firebase Admin SDK.
    ...
    // 3. Set the content of that JSON file as an environment variable named GOOGLE_APPLICATION_CREDENTIALS_JSON
    // If you encounter a "Failed to provision project" or "configuration incomplete" error,
    // it means the environment is not set up correctly.
                          ...
                          <FormItem>
                            <FormLabel>Agence de destination</FormLabel>
                             <Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <SelectContent>
                                {offices.map(office => (
                                  <SelectItem key={office.city} value={office.city}>{office.city}</SelectItem>
                                ))}
                              </SelectContent>
                            </Select>
                            <FormMessage />
